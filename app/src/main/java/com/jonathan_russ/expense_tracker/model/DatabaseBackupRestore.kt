package com.jonathan_russ.expense_tracker.model

import android.content.Context
import android.net.Uri
import com.jonathan_russ.expense_tracker.forEachEntry
    ...
    private fun extractZipToDirectory(
        ...
        ZipInputStream(inputStream).use { zipInputStream ->
            zipInputStream.forEachEntry { entry ->
                ...
                if (!outputFile.canonicalFile.normalize()
                        .startsWith(File(targetPath).canonicalFile)
                ) {
